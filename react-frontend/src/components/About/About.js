...
const About = () => (
  <main className="aboutPage">
    ...
    <div className="text2">
      <h2>The page(?)</h2>
      <p>
        The main purpose of the construction of this site is to keep Aberdeen
        citizens informed about the quality of the air that they breathe daily.
        It is a great advantage for the prevention of health problems to know
        what you are breathing when walking to work, university, going for a
        walk or even when inside your home. The sensors measure the levels of
        particulate matter 10 and particulate matter 2.5, the diameter of these
        particles is smaller than a human hairs diameter. The World Health
        Organisation, WHO, state that globally 2.1 million deaths are caused
        fine particulate matter, this makes the need for information about air
        quality a major subject. Even though Aberdeen particulate matter levels
        are normally below the maximum permitted level, it may exceed these
        levels from time to time and for some users, it is crucial to be
        informed about it.
      </p>
    </div>
    <div className="text3">
