describe("landscape sidebar", () => {
  ...
  it("navigates to /about", () => {
    cy.get(".sidebar").contains("About us").children().should("be.visible");
    cy.get(".sidebar").contains("About us").children().click();
  ...
  it("navigates to /help", () => {
    cy.get(".sidebar")
      ...
      .children()
      .should("be.visible");
    cy.get(".sidebar").contains("How you can help").children().click();
